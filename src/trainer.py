...
class ClassifTrainer(object):
    ...
    def __init__(self, args):
        ...
        self.num_cpus = min(10, cpu_count() - 1) if cpu_count() > 1 else 1 ### TO DO : issue on server with dbpedia , dataset lead to too big a chunk apparently, must set to 1, need a fix
